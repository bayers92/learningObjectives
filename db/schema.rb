...
ActiveRecord::Schema.define(version: 20161117020541) do
  ...
  create_table "posts", force: :cascade do |t|
    ...
    t.integer  "block"
    t.string   "label"
    t.string   "marker",                    default: "unspecified"
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean  "blockyy1",               default: false
    t.boolean  "blockyy2",               default: false
    t.boolean  "blockyy3",               default: false
    t.boolean  "blockyy4",               default: false
    t.boolean  "blockyy5",               default: false
    t.integer  "rez",                    default: [],                 array: true
  end
